    ...
    <div class="row">
        <div class="col-md-12">
            <table id="example" class="table table-striped table-bordered" >
                ...
                <tbody>
                <?php
                $query = "select * from kendaraan where username = '".$_SESSION['username']."'";
                    ...
                    while($data = mysqli_fetch_assoc($hasil) ){
                        ?>
                            <tr>
                                ...
                                <td class="center">
                                    <a href="editKendaraan.php?q=<?php echo $data['idKendaraan']; ?>"><button type="button" class="btn btn-success seePic ">Edit</button></a>
                                    <a href="hapusKendaraan-delete.php?q=<?php echo $data['idKendaraan']; ?>"><button type="button" class="btn btn-danger seePic ">Hapus</button></a>
                                </td>
